...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style/style.css */ \"./src/style/style.css\");\n/* harmony import */ var _scripts_printTasks_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/printTasks.js */ \"./src/scripts/printTasks.js\");\n/* harmony import */ var _scripts_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/filter */ \"./src/scripts/filter.js\");\n\n\n\n\n(0,_scripts_printTasks_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n(0,_scripts_filter__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorage */ \"./src/scripts/localStorage.js\");\n/* harmony import */ var _printTasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./printTasks */ \"./src/scripts/printTasks.js\");\n/* harmony import */ var _queries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./queries */ \"./src/scripts/queries.js\");\n\n\n\n\nconst tasks = _localStorage__WEBPACK_IMPORTED_MODULE_0__.getLocal;\n\nfunction taskFilter() {\n  const filtered = tasks.filter((task) => task.completed === true);\n  (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.updateLocal)(filtered);\n  (0,_printTasks__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n}\n\nfunction filterBtn() {\n  const clearBtn = (0,_queries__WEBPACK_IMPORTED_MODULE_2__.getElement)('#clear-btn');\n  clearBtn.addEventListener('click', taskFilter());\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (filterBtn);\n\n//# sourceURL=webpack://to-do-list/./src/scripts/filter.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"updateLocal\": () => (/* binding */ updateLocal),\n/* harmony export */   \"getLocal\": () => (/* binding */ getLocal)\n/* harmony export */ });\nfunction updateLocal(tasks) {\n  localStorage.setItem('todolist', JSON.stringify(tasks));\n}\n\nfunction getLocal() {\n  if (localStorage) {\n    const tasks = JSON.parse(localStorage.getItem('todolist'));\n    return tasks;\n  }\n  return -1;\n}\n\n\n\n//# sourceURL=webpack://to-do-list/./src/scripts/localStorage.js?");

/***/ }),

/***/ "./src/scripts/printTask.js":
/*!**********************************!*\
  !*** ./src/scripts/printTask.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorage */ \"./src/scripts/localStorage.js\");\n/* harmony import */ var _queries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./queries */ \"./src/scripts/queries.js\");\n\n\n\nfunction printTask(task, tasks) {\n  const objIndex = tasks.findIndex((obj) => obj.index === task.index);\n  const li = (0,_queries__WEBPACK_IMPORTED_MODULE_1__.createElement)('li');\n  const done = (0,_queries__WEBPACK_IMPORTED_MODULE_1__.createElement)('input');\n  done.type = 'checkbox';\n  done.checked = task.completed;\n  if (task.completed) li.classList.add('completed');\n  done.addEventListener('change', () => {\n    li.classList.toggle('completed');\n    if (done.checked) {\n      tasks[objIndex].completed = true;\n      (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.updateLocal)(tasks);\n    } else {\n      tasks[objIndex].completed = false;\n      (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.updateLocal)(tasks);\n    }\n  });\n  const description = (0,_queries__WEBPACK_IMPORTED_MODULE_1__.createElement)('span');\n  description.innerHTML = task.description;\n  const menu = (0,_queries__WEBPACK_IMPORTED_MODULE_1__.createElement)('span');\n  menu.innerHTML = '⋮';\n  menu.className = 'task-options';\n  li.appendChild(done);\n  li.appendChild(description);\n  li.appendChild(menu);\n  (0,_queries__WEBPACK_IMPORTED_MODULE_1__.getElement)('#tasks').appendChild(li);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (printTask);\n\n//# sourceURL=webpack://to-do-list/./src/scripts/printTask.js?");

/***/ }),

/***/ "./src/scripts/printTasks.js":
/*!***********************************!*\
  !*** ./src/scripts/printTasks.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _localStorage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorage.js */ \"./src/scripts/localStorage.js\");\n/* harmony import */ var _printTask_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./printTask.js */ \"./src/scripts/printTask.js\");\n/* harmony import */ var _tasks_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tasks.js */ \"./src/scripts/tasks.js\");\n\n\n\n\nlet tasks = [];\n\nfunction printTasks() {\n  const local = (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.getLocal)();\n  if (local) {\n    tasks = local;\n  }\n  tasks = (0,_tasks_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(tasks);\n  tasks.forEach((task) => (0,_printTask_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(task, tasks));\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (printTasks);\n\n//# sourceURL=webpack://to-do-list/./src/scripts/printTasks.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getElement\": () => (/* binding */ getElement),\n/* harmony export */   \"createElement\": () => (/* binding */ createElement)\n/* harmony export */ });\nfunction getElement(element) {\n  return document.querySelector(element);\n}\n\nfunction createElement(element) {\n  return document.createElement(element);\n}\n\n\n\n//# sourceURL=webpack://to-do-list/./src/scripts/queries.js?");
